...
const messages = {
  en: {
    ...
    boards: {
      ...
      createCard: 'Create board',
      titleLabel: 'Board title',
      createSubmit: 'Create',
      createCancel: 'Cancel',
      createError: 'Could not create the board. Try again.',
      editBoard: 'Edit board',
      editSave: 'Save',
      editError: 'Could not update the board. Try again.',
      deleteBoard: 'Delete board',
      deleteConfirm: 'Delete this board? This cannot be undone.',
      deleteSubmit: 'Delete',
      deleteError: 'Could not delete the board. Try again.',
      ariaEditBoard: 'Edit board',
      ariaDeleteBoard: 'Delete board',
    },
    welcome: {
